...
1. Téléchargez ce dépôt (bouton **Code** puis **Download ZIP** sur GitHub) et décompressez-le.
2. Double-cliquez sur `installer.bat`.
3. Si Python manque, la page de téléchargement s'ouvre. Installez-le en cochant la case
